...
Read the documentation on [CppUTest](http://cpputest.github.io/)
online.

## License(s)

The license for this kata can be found in the LICENSE.md file, - but
be advised that the CppUTest library found in the lib folder has its
own license terms. Please read that license relating specifically to
CppUTest.
