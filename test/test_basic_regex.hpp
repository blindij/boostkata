...
std::string marys_modified_story("{Ma}ry had{ a} little lamb.\n"
                                 ...
                                 "went the lamb was sure\n"
                                 "to go.\n");
REQUIRE(re_show("[^a-z]a", marys_story)
...
std::string marys_modified_story("{Mary had} a little lamb.\n"
                                 ...
                                 "went the lamb was sure\n"
                                 "to go.\n");
REQUIRE(re_show("(Mary)( )(had)", marys_story)
== marys_modified_story);
}
...
std::string marys_modified_story("Mary had a little lamb.\n"
                                 ...
                                 "went the lamb was sure\n"
                                 "to go.\n");
REQUIRE(re_show("Mary$", marys_story)
== marys_modified_story);
}
...
REQUIRE(re_show("(\\\\)", escaped)
== modified_escaped);              // to be part of the strings.
}
